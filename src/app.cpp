...
void Application::processInput(wgpu::raii::CommandEncoder& enc, std::vector<FluidSource>& frameSources) {
...
void Application::update(wgpu::raii::CommandEncoder& enc, std::span<const FluidSource> frameSources) {
...
std::pair<wgpu::raii::Texture, wgpu::raii::TextureView> Application::render(wgpu::raii::CommandEncoder& enc) {
    WGPUContext& ctx = WGPUContext::instance();
